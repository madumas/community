...
> \(\(\(Borrowed DAI \* \(1 + Current Stability Fee in decimal format\)\) ^ \(Age of Stability Debt in days/365\)\) - Borrowed DAI \) = Total Stability Fee owed in DAI
...
> \(\(CDP debt in DAI \* \(1 + Current Stability Fee in decimal format\)\) ^ \(Age of Debt in days/365\)\) - CDP Debt in DAI\) = Total Stability Debt owed in DAI
